...
* Created: **2026-03-22**; Modified: **2026-03-26**; Status: **Dormant**
* Tags: #resource #learningdiary #pkm #personal #knowledge #management #ai #sovereignai
* Related: [:README](); [:Digital:Assistant](); [:Digital:AI]()
...
| Linking model   | `[:Digital:AI]()` or `[./Digital/AI.txt](./AI-PKM-LD_files/Digital/AI.txt)` | `@mention` or UUID-based links    |
...
| `[WikiLink]()`                                                                                      | Notion page `@mention`        | Low (manual remap)     |
| [path:to:page]()                                                                                    | Nested page link (UUID-based) | Low (requires mapping) |
...
![](./AI-PKM-LD_files/pasted_image001.png)![](./AI-PKM-LD_files/pasted_image002.png)
...
![](./AI-PKM-LD_files/pasted_image.png)
